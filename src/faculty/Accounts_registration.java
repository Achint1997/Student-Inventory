 ...
 * @author HP
 */
public class Accounts_registration extends JFrame implements ActionListener,ItemListener{
    JLabel lb1;
    ...
    public Accounts_registration(String text1, String text2, String str) {
        con = JdbcConnection.getConnection();
        tex1 = text1;
        tex2 = text2;
        pass = str;
        //JOptionPane.showConfirmDialog(this, "ONE PENDING LEAVE");
        lb1 = new JLabel("ACCOUNTS REGISTRATION");
