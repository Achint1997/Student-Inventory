...
public class Faculty_after_login extends JFrame implements ActionListener {
    ...
    public Faculty_after_login(String o) {
        ...
        String str1 = "    -  -  ";
        try {
            String submit1 = "select * from faculty_registration where college_id='" + aft_login + "'";
    ...
    public void actionPerformed(ActionEvent ae) {
        if ("ASSIGNMENTS".equals(ae.getActionCommand())) {
            System.out.println(aft_login);
            new Assignment_input_1(aft_login);
            dispose();
        } else if ("LECTURES".equals(ae.getActionCommand())) {
            System.out.println(aft_login);
            new Lecture_upload(aft_login);
            dispose();

        } else if ("LEAVE".equals(ae.getActionCommand())) {
            System.out.println(aft_login);
            new Leave_chooser(aft_login);
            dispose();
        }else if ("GRIEVANCES".equals(ae.getActionCommand())) {
            System.out.println(aft_login);
            new Grievances_chooser(aft_login);
            dispose();
        }
